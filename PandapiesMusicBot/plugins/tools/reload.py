...
from PandapiesMusicBot.utils.database import get_authuser_names, get_cmode
from PandapiesMusicBot.utils.decorators import ActualAdminCB, AdminActual, language
from PandapiesMusicBot.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Pandapies.stop_stream(message.chat.id)
    except:
        pass
