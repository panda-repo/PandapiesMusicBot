...
from PandapiesMusicBot import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from PandapiesMusicBot.core.call import Pandapies
from PandapiesMusicBot.utils import seconds_to_min, time_to_seconds
from PandapiesMusicBot.utils.channelplay import get_channeplayCB
from PandapiesMusicBot.utils.database import is_video_allowed
from PandapiesMusicBot.utils.decorators.language import languageCB
from PandapiesMusicBot.utils.decorators.play import PlayWrapper
from PandapiesMusicBot.utils.formatters import formats
from PandapiesMusicBot.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
)
from PandapiesMusicBot.utils.inline.playlist import botplaylist_markup
from PandapiesMusicBot.utils.logger import play_logs
from PandapiesMusicBot.utils.stream.stream import stream
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                await Pandapies.stream_call(url)
...
@app.on_callback_query(filters.regex("PandapiesPlaylists") & ~BANNED_USERS)
@languageCB
