...
from PandapiesMusicBot.utils import help_pannel
from PandapiesMusicBot.utils.database import get_lang, is_commanddelete_on
from PandapiesMusicBot.utils.decorators.language import LanguageStart, languageCB
from PandapiesMusicBot.utils.inline.help import help_back_markup, private_help_panel
    ...
    if cb == "hb5":
        if CallbackQuery.from_user.id not in SUDOERS:
            return await CallbackQuery.answer(
                "Hanya Untuk Owner dan Sudo User", show_alert=True
            )
        else:
