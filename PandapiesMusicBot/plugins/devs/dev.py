...
from PandapiesMusicBot import Telegram, YouTube, app
from PandapiesMusicBot.misc import SUDOERS
from PandapiesMusicBot.plugins.play.playlist import del_plist_msg
from PandapiesMusicBot.plugins.sudo.sudoers import sudoers_list
...
from PandapiesMusicBot.utils.decorators.language import LanguageStart
from PandapiesMusicBot.utils.inline import help_pannel, private_panel, start_pannel
from PandapiesMusicBot.utils.command import commandpro
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/PandaProject_ID) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
@app.on_message(commandpro(["/alive", "Pandapies"]) & ~filters.edited)
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/c11bc24f9be8f4d8f1666.jpg",
        caption=f"""━━━━━━━━━━━━━━━━━━━━━━━━\n\n✪ ʜᴇʟʟᴏ, {MUSIC_BOT_NAME} ɪs ᴡᴏʀᴋɪɴɢ ᴀɴᴅ ғᴜɴᴄᴛɪᴏɴɪɴɢ ᴘʀᴏᴘᴇʀʟʏ\n\n💞 ɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴏɴs ᴛʜᴇɴ\nᴅᴍ ᴛᴏ ᴍʏ [ᴏᴡɴᴇʀ](https://t.me/panda_repo) ᴍᴀᴋᴇ sᴜʀᴇ ᴛᴏ sᴛᴀʀ ᴏᴜʀ ᴘʀᴏᴊᴇᴄᴛ ...\n\n━━━━━━━━━━━━━━━━━━━━━━━━
""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🐼 Panda 🐼", url=f"https://t.me/PandaProject_ID")]]
        ),
    )
