...
/pause : Untuk menjeda stream yang sedang berjalan.
/resume : Untuk melanjutkan stream.
/mute : Untuk membisukan stream yang sedang berjalan.
/unmute : Untuk membunyikan stream yang sedang berjalan.
/skip : Untuk melanjutkan ke daftar putar selanjutnya.
/end ᴏʀ /stop : Untuk menghentikan stream.
/shuffle : mengacak trek yang telah diputar.
/seek : Untuk loncati durasi yang di inginkan
/seekback : Untuk mundur mencari durasi yang di inginkan.
/reboot : Memulai ulang bot untuk chat.
